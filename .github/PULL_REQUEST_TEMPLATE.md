...
- [ ] Nothing points somewhere a reader cannot follow — no private links, no bare internal citations
      (code comments included: they ship in the `.d.ts` and reach users on hover)
