/**
 * `@cloudbitmaps/roaring/redis` — a thin re-export of `@cloudbitmaps/core/redis`.
 *
 ...
 * `import { … } from '@cloudbitmaps/roaring/redis'` — instead of also naming core, which arrives transitively.
 * Importing from `@cloudbitmaps/core/redis` is equivalent.
 */
export * from '@cloudbitmaps/core/redis';
