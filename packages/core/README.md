...
that enforces it), and **every storage driver** (S3 · GCS · Azure Blob cold, S3 · GCS · Azure Blob · DynamoDB
registry, each on its own subpath with the backend SDK as an optional peer dependency).
