...
`publishGeneration` · `CrbmColdChunkSource` · `nextGeneration` · `gcOrphanGenerations` · `loadSegment` · `eraseIdFromSegment` ·
...
`BulkLoadResult` · `LoadDeps` · `LoadOptions` · `LoadGuard` · `LoadResult` · `LoadRefusal` · `CrbmColdChunkSourceOptions` · `GenerationDeps` · `EraseIdDeps` · `EraseIdResult` ·
