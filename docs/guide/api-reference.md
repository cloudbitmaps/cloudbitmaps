...
`publishGeneration` · `CrbmColdChunkSource` · `nextGeneration` · `gcOrphanGenerations` · `loadSegment` · `listGenerations` · `rollbackSegment` · `eraseIdFromSegment` ·
...
`BulkLoadResult` · `LoadDeps` · `LoadOptions` · `LoadGuard` · `LoadResult` · `LoadRefusal` · `GenerationListDeps` · `GenerationEntry` · `RollbackResult` · `CrbmColdChunkSourceOptions` · `GenerationDeps` · `EraseIdDeps` · `EraseIdResult` ·
