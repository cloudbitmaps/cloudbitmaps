...
| **contributing / understanding the design** | [**`internal/`**](internal/) — the design specs, threat/cost models, phase plans, research, decision log, and roadmap (project planning; the source of project state) |
...
envelope, and what's next — and the [**usage walkthrough**](internal/) shows the full end-to-end
