...
| You are… | Go to |
|---|---|
| **using CloudBitmaps** (or evaluating it) | [**`guide/`**](guide/) — user-facing docs: getting started, how-tos, kept accurate to what's actually shipped — plus the [**public roadmap**](ROADMAP.md) and [**benchmarks**](benchmarks.md) |
